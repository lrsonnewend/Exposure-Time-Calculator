				...
				<div id="portal-column-content" class="cell width-3:4 position-1:4">
					...
					<div id="main-content">    
						<div id="content">
							...
							<br>
							<!--Form -->
							<form method="post" id="fEtc" name="etcForm" action="source/Controller/ControllerCD.php">
								<fieldset>
									<p>
										<label for="cMag">Magnitude</label><br>
										<input type="Number" name="tMagCD" id="cMag" min="0" max="23" size="15" value="15"  step="0.01" required/><font>mag</font>
									</p>
										
										<label for="cBin">Binning</label>
										<br>
										<select name="tBinCD" id="cBin">
										...
										<!-- Begin Modal -->
											...
											<div id="id01" class="w3-modal">
											 <div class="w3-modal-content w3-card-4 w3-animate-zoom">
											  ...
											  <!-- Begin Table -->
											 	<?php include("etc/views/tabelasCCDIAGPOL.php"); ?>
											  <!-- End Table -->
									...
									<p>	<label>Focal Reducer</label><br>
										<input type="radio" name="tFocalCD" id="cFocal1" value="1">
										<label for="cFocal1">Yes</label>
										<input type="radio" name="tFocalCD" id="cFocal2" checked value="0">
										<label for="cFocal2">No</label>
									</p>
									<p>									
										<label>Filter</label><br>
										<input type="radio" name="tFilterCD" id="cFil1" value="U">
										<label for="cFil1">U</label>&nbsp;&nbsp;
										<input type="radio" name="tFilterCD" id="cFil2" value="B">
										<label for="cFil2">B</label>&nbsp;&nbsp;
										<input type="radio" name="tFilterCD" id="cFil3" checked value="V">
										<label for="cFil3">V</label>&nbsp;&nbsp;
										<input type="radio" name="tFilterCD" id="cFil4" value="R">
										<label for="cFil4">R</label>&nbsp;&nbsp;
										<input type="radio" name="tFilterCD" id="cFil5" value="I">
										<label for="cFil5">I</label>
									</p>
									<p>
										<label>Moon Phase</label><br>
										<input type="radio" name="tMoonCD" id="cMoon1" checked="checked" value="new">
										<label for="cMoon1">New</label>
										<input type="radio" name="tMoon" id="cMoon2" value="quarter">
										<label for="cMoon2">Quarter</label>
										<input type="radio" name="tMoonCD" id="cMoon3" value="full">
										<label for="cMoon3">Full</label>
									</p>
									<p>
										<label>Sky quality</label><br>
										<input type="radio" name="tSkyCD" id="cSky1" checked value="photometric">
										<label for="cSky1">Photometric</label>
										<input type="radio" name="tSkyCD" id="cSky2" value="good">
										<label for="cSky2">Good</label>
										<input type="radio" name="tSkyCD" id="cSky3" value="regular">
										<label for="cSky3">Regular</label>
									</p>
									<p>
										<label for="cAperture">Air Mass</label><br>
										<input type="Number" name="tAirMassCD" id="cAirMass" value="1" size="15" min="1" max="3" step="0.01" required>
									</p>
									<p>
									...
									<p>	<label>ETC Mode</label><br>
										<a onclick="changeState('boxTime','block','boxSigma','none')">
											<input type="radio" name="tModeCD" id="cMode1" value="1" required>
										</a>
										<label for="cMode1">Calculate the magnitude error for a given integration time</label></br>
									...
									<p>
										<div id="boxTime">
											...
											<input type="Number" name="tTempCD" id="cTemp" min="1" max="100000" size="15" value="60" /><font>s</font>
										</div>
									</p>
									<p>
										<div id="boxSigma">
									...
									<input type="reset" name="creset" value="Reset Values">
								</fieldset>

 <?php 
	...
	$sigmaM = isset($_SESSION['results']['sigmaM']) ? $_SESSION['results']['sigmaM']: 0;
	$snr = isset($_SESSION['results']['snr']) ? $_SESSION['results']['snr']: 0;
	$data = $_SESSION['results']['dataSet'];	
	$GLOBALS['time'] = $time;
	$GLOBALS['sigmaM'] = $sigmaM;
...
<body>
	...
	<div class="output" id="output">
		...
		<section>
			...
			<?php
				...
				if($_SESSION['results']['inSigmaM']!=0)
				{
					echo 'Error of the linear magnitude: '.$_SESSION['results']['inSigmaM'].' %<br>';
				}
	...
	<div id="divGraph" class="output">
		<br>
		<br>
		<img src="<?php echo $plot->EncodeImage();?>" alt="Graph Magnitude Error X Time">
	
	<br>
		<button onclick="window.print()" style="font-size: 15pt;">Print results</button>
	</div>
	<footer id="footer">
		<p>Calculated by Exposure Time Calculator/CCD Imager</p>

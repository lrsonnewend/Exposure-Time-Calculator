...
$(document).ready(function () {
	var elementos = $('.button-holder').children();
	var indexInicial = elementos.length - 1;
	var tempoDelayMs = 10 * 1000;
	var timeFade = tempoDelayMs / 20;

	var index = indexInicial - 1;
	...
	var passaElementos = function passaElementos() {
		if (elementos.length > 1) {
			...
			var elementoAtual = elementos[index];
